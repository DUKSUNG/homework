drop table ForeignActress;
-- 20140928 첫번째 테이블 만들기
-- 소재 : 외국 여배우

-- 1.create 
create table ForeignActress (AName varchar(255), ABirth int, AHeight int, ASchool varchar(255), AFirstMovie varchar(255), ALover varchar(1));
