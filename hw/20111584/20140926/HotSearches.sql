--@14.10.08 Google hot searches (Tuesdat, October 7, 2014)

--*create
create table HotSearches( rank int, words varchar(255), searches varchar(255), related searches varchar(255));
