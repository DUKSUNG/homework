[create]create table CLASS (course varchar(255), professor varchar(11), classroom              varchar(11), lecture_time varchar(11), target_grade varchar(11) );
[insert] insert into CLASS (course, professor, classroom, lecture_time, target_grade) values('데이터베이스응용', '권혁진', '차339', '금6-8', '3학년');
...
[update] update CLASS set classroom='휘트니스' where course='휘트니스 트레이닝';
[delete]delete from CLASS where course='영화로 읽는 사회와문화';
