[create]create table FRIENDS (id int, name varchar(255), major varchar(10), favorite_thing varchar(10), height int(10) );
[insert] insert into FRIENDS (id, name, major, favorite_thing, height) values (1, '함진아', '국어교육과', '독서', 156);
...
[delete] delete from FRIENDS where name='이영진';
[update] update FRIENDS set height=158 where name='유성원';
