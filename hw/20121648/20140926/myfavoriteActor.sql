-- 2014년 9월 30일 첫번째 테이블 myfavoriteActor.sql

drop table myfavoriteActor;
-- use DS_20121648;
...
-- 3.update
update myfavoriteActor set name='박서준',tall='키184',bloodtype='AB형',work='금나와라 뚝딱' where sort=2;
-- 4.delete
